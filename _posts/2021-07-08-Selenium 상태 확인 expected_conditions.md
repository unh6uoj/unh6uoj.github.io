...
이런 문제를 해결하기 위해 selenium에선 WebDriverWait이라는 모듈을 통해 로딩을 대기하는 방법을 제공해주고 있다.  
...
이 글에선 Explicit Waits에서 사용되는 expected_conditions에 대해서 소개를 해보려고 한다.
...
- text_to_be_present_in_element(**locator, text_**)
  - text_가 locator에 존재하는지 확인한다. 존재하면 true, 없다면 false를 반환
